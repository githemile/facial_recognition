...
window = tk.Tk()
# Charger l'image
icon_image = tk.PhotoImage(file="/home/emiletech/Téléchargements/Face-Recognition-Login-System/Face-Recognition-Login-System-main/Images/1006.jpeg")
    ...
    def fill_attendance():
        ...
        if subb == '':
            ...
            def attf():
                import subprocess
                subprocess.Popen(
                    r'explorer /select,"C:/Python36/Attendace_system_major_project/Attendance/Manually Attendance/-------Check atttendance-------"')
...
def subjectchoose():
    ...
    def Attf():
        import subprocess
        subprocess.Popen(
            r'explorer /select,"C:/Python36/Attendace_system_major_project/Attendance/-------Check atttendance-------"')
